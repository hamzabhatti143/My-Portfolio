  ...
  return (
    <>
      <div
        ...
        className="w-full flex flex-col justify-center aos-init aos-animate items-center mt-6 md:mt-12"
      >
        <Image
        ...
        <h5
          data-aos="fade-down"
          className="text-base text-black md:text-[#EF6D58] w-full md:w-1/2 px-6 mt-10 md:mt-20"
        >
          Hamza Bhatti
        </h5>
        <h1
        ...
        <p
          data-aos="fade-up"
          className="w-full text-black md:w-1/2 px-6 leading-7 tracking-wider mt-4"
        >
      ...
      <div
        data-aos="fade-down"
        className="w-full px-4 md:px-20  flex flex-col md:flex-row justify-center items-center mt-10"
      >
        <div
        ...
        >
          ...
          <div>
            ...
            <p className="text-base md:text-xs lg:text-base text-black">
              Projects Done
            </p>
          </div>
        </div>
